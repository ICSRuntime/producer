...
public class ProducerRouting {
    ...
    private static final Logger logger = LoggerFactory.getLogger("producer:1");
    ...
    public static void main(String[] args) {
        ...
        afterAfter(new Filter() {
        	...
        	public void handle(Request request, Response response) throws Exception {
        		...
        		logger.info("log message {} {} {} {} ns", value("apiname", "producer"), value("apiversion", "1"), value("apipath", request.pathInfo()), value("response-timing", (end-start)));
        	}
        });
